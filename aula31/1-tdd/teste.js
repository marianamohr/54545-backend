...
console.log("Teste 1 - senha vazia, deve retornar sem senha fornecida");
let result1 = login("Coder");

if (result1 === "Sem senha fornecida") {
...
if (testesAprovados === testesTotais) {
  ...
  console.log("Pelo menos um teste não passou");
}
